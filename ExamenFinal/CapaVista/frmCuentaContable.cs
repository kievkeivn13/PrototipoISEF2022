...
namespace CapaVista
{
    public partial class frmCuentaContable : Form
    {
        public frmCuentaContable()
        {
            ...
            navegador1.ObtenerCamposdeTabla(alias, "cuentacontable", "hotelSanCarlos");
            navegador1.MetodoSalirVista(this);
            navegador1.LlenarCombobox(cbxIDTipo, "tipocuenta", "idTipoCuenta", "nombre", "estado");
        ...
        {
            navegador1.EnviarDatoComboaTextbox(cbxIDTipo, txtIDTipoCuenta);
        }

        private void txtIDEmpresa_TextChanged(object sender, EventArgs e)
        {
            navegador1.SeleccionarElementosenCombo(cbxIDTipo, txtIDTipoCuenta);
        }
