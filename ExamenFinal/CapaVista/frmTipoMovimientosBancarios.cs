...
namespace CapaVista
{
    public partial class frmTipoMovimientosBancarios : Form
    {
        public frmTipoMovimientosBancarios()
        {
            InitializeComponent();
            TextBox[] alias = navegador1.ClasificaTextboxsegunParent(this);
            navegador1.ObtenerCamposdeTabla(alias, "tipomovimientosbancarios", "hotelSanCarlos");
